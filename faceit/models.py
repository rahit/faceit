...
import requests
from faceit.setting import FACEBOOK_APPLICATION_ID, FACEBOOK_APPLICATION_SECRET_KEY
...
class FacebookOAuthToken(models.Model):
    """
...
class FacebookProfile(models.Model):
    ...
    """A User object referring the user."""
    ...
    oauth_token = models.OneToOneField(FacebookOAuthToken, verbose_name=_('OAuth token'))
